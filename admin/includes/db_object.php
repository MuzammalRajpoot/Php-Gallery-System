...
class Db_object {
    ...
    public static function find_by_id($id) {
        $the_object_array = static::find_by_query("SELECT * FROM " . static::$db_table . " WHERE id = $id LIMIT 1");
    ...
    public static function find_by_query($sql) {
        ...
        while ($row = mysqli_fetch_array($result_set)) {
            $the_object_array[] = static::instantition($row);
            //var_dump($the_object_array);
        }
        return $the_object_array;
    }
       public static function instantition($the_record) {
